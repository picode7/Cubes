...
class GUI {
    ...
    constructor() {
        ...
        game.pointer.onchange.register((locked) => {
            if (locked == false && this.layer == GUI_LAYER.ingame)
    ...
    updateOptionsGUI() {
        ...
        (<HTMLSelectElement>document.getElementById("settings_renderScale")).selectedIndex = [25, 50, 75, 100, 150, 200].indexOf(game.options.renderScale);
    }
    ...
    updateOptions(reload = false) {
        ...
        game.options.renderScale = [25, 50, 75, 100, 150, 200][(<HTMLSelectElement>document.getElementById("settings_renderScale")).selectedIndex]
